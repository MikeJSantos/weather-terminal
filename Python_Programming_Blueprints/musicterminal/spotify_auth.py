...
from pytify.core import read_config, BadRequestError
from pytify.auth import Authorization, get_auth_key
...
def _authorization_code_request(auth_code):
    ...
    # TODO: merge functionality with _refresh_access_token()?
